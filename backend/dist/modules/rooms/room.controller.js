...
__decorate(
	[
		...
		swagger_1.ApiConflictResponse({
			...
			schema: new basic_response_schema_1.BasicResponseSchema(
				'Room for this user already exist'
			),
		}),
...
__decorate(
	[
		...
		__metadata('design:paramtypes', [
			String,
			String,
			set_room_ready_dto_1.SetRoomReadyDto,
			Object,
		]),
		__metadata('design:returntype', Promise),
	],
...
__decorate(
	[
		...
		swagger_1.ApiForbiddenResponse({
			description: 'Authorization error',
			schema: new basic_response_schema_1.BasicResponseSchema(
				'Only the creator of room can modify it'
			),
		}),
		swagger_1.ApiBadRequestResponse({
			description: 'This action is now locked',
		...
		__metadata('design:paramtypes', [
			String,
			String,
			submit_note_dto_1.SubmitNoteDto,
			Object,
		]),
		__metadata('design:returntype', Promise),
	],
...
__decorate(
	[
		...
		__metadata('design:paramtypes', [
			String,
			String,
			remove_note_dto_1.RemoveNoteDto,
			Object,
		]),
		__metadata('design:returntype', Promise),
	],
