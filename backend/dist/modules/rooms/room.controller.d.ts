...
export declare class RoomController {
    ...
    setReady(seed: string, id: string, setRoomReadyDto: SetRoomReadyDto, response: Response): Promise<void>;
    submitNote(seed: string, id: string, submitNoteDto: SubmitNoteDto, response: Response): Promise<void>;
    removeNote(seed: string, id: string, removeNoteDto: RemoveNoteDto, response: Response): Promise<void>;
}
