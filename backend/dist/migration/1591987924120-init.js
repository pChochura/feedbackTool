...
class init1591987924120 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "Session" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_b2d57e0f3ce66780706d739e274" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Note" ("id" character varying(16) NOT NULL, "content" character varying(512) NOT NULL, CONSTRAINT "PK_a677a8365a6131301c9c01254e9" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "List" ("id" character varying(16) NOT NULL, "name" character varying(64) NOT NULL, "notesId" character varying(16), CONSTRAINT "PK_1727d6c80966414bf9543429d58" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "Room" ("id" character varying(16) NOT NULL, "sessionId" character varying(16) NOT NULL, "name" character varying(64) NOT NULL, "ready" boolean NOT NULL, "listsId" character varying(16), CONSTRAINT "PK_867d589be92524f89375e2e086d" PRIMARY KEY ("id"))`);
